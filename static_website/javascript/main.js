    var marcApp = angular.module('marcApp', ['ngRoute', "chart.js"]);
    ...
    marcApp.controller('IndustryController', ["$scope", "candyPeople", "industry", function($scope, candyPeople, industry) {
        console.log("market")
